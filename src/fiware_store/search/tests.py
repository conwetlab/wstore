...
class IndexCreationTestCase(TestCase):
    ...
    def tearDownClass(cls):
        path = settings.BASEDIR + '/fiware_store/test/test_index'
    ...
    def test_basic_index_creaton(self):
        ...
        se = SearchEngine(settings.BASEDIR + '/fiware_store/test/test_index')
        se.create_index(offering)

        lucene.initVM()
        index = SimpleFSDirectory(File(settings.BASEDIR + '/fiware_store/test/test_index'))
...
class FullTextSearchTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        lucene.initVM()
        index_path = settings.BASEDIR + '/fiware_store/test/test_index'
    ...
    def test_search_not_existing_index(self):
        ...
        se = SearchEngine(settings.BASEDIR + '/fiware_store/test/no_index')
